...
This command **requires** the project directory as an argument via `/home/packnation82/projects/CryptoTrader`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/home/packnation82/projects/CryptoTrader/prompts/app_spec.txt` and `/home/packnation82/projects/CryptoTrader/prompts/initializer_prompt.md`

If `/home/packnation82/projects/CryptoTrader` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/home/packnation82/projects/CryptoTrader/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/home/packnation82/projects/CryptoTrader/prompts/app_spec.txt`
...
**Output path:** `/home/packnation82/projects/CryptoTrader/prompts/initializer_prompt.md`
...
**Output path:** `/home/packnation82/projects/CryptoTrader/prompts/.spec_status.json`
...
> "Your specification files have been created in `/home/packnation82/projects/CryptoTrader/prompts/`!
>
> **Files created:**
> - `/home/packnation82/projects/CryptoTrader/prompts/app_spec.txt`
> - `/home/packnation82/projects/CryptoTrader/prompts/initializer_prompt.md`
>
